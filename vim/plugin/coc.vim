...
function! ExpandInsertDefineFunctionSnippet()
  execute "normal o deffun\<esc>==A\<Plug>(coc-snippets-expand)"
endfunction
nmap <silent><leader>d :call ExpandInsertDefineFunctionSnippet()<CR>
